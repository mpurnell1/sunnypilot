...
class AugmentedRoadView(CameraView):
  ...
  def _handle_mouse_release(self, mouse_pos: MousePos):
    # Don't trigger click callback if bookmark was triggered or a HUD widget took the tap
    hud_interacting = getattr(self._hud_renderer, 'user_interacting', lambda: False)()
    if not self._bookmark_icon.interacting() and not hud_interacting:
